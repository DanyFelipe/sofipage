/**
 * Content of the letter, split into pages.
 * Each page is shown independently with pagination controls.
 * Add or remove objects in the `pages` array to add or remove pages.
 */
export const LETTER_CONTENT = {
  greeting: 'Sofía,',
  closing: 'Con todo el cariño,',
  signature: 'Daniel',

  pages: [
    {
      paragraphs: [
        'Desde que coincidimos hace unos meses, has ido ocupando más espacio del que esperaba en mi cabeza. Y aunque hay muchas cosas que me gustaría decirte, como ya te diste cuenta, no soy alguien muy conversador ni con una labia encantadora… y mucho menos por chat. Supongo que por eso terminé buscando otra forma de hacerlo.',
      ],
    },
    {
      paragraphs: [
        'Recuerdo cuando me mostraste algunas de las cartas que escribes y otras que te han dedicado. Ahí entendí lo profundo que puede ser poner en palabras lo que uno siente. Desde ese momento, la idea de intentar algo así contigo se me quedó dando vueltas y, de cierta forma, terminaste inspirándome a escribirte esto.',
      ],
    },
    {
      paragraphs: [
        'Aunque no sabía muy bien cómo hacerlo, ni cómo hacértelo llegar de una forma especial, encontré en lo que más me gusta una manera de acercarme a eso. Por eso hice esta página para ti, desarrollándola y llenándola de pequeños detalles en 3d que nacen de mí… como una forma de plasmar, aunque sea un poco, lo que quiero transmitirte.',
      ],
    },
    {
      paragraphs: [
    ...
    {
      paragraphs: [
        'Hay algo en ti que me llamó la atención desde el principio… una forma de ser que no es tan común, y que, sin darme cuenta, terminó quedándose más de lo que esperaba. Supongo que por eso haber coincidido contigo no es algo que quiera pasar por alto.',
      ],
    },
    {
      paragraphs: [
